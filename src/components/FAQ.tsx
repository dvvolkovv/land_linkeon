...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Базовое общение с ассистентами - каждый день начисляется 20000 токенов бесплатно, хочешь глубже - есть 3 тарифа на выбор. Расширенные функции (глубокий поиск совпадений, совместимость) — бесплатно.'
  },
  {
