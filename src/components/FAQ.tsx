...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Базовое общение с ассистентами и создание профиля — доступно. Расширенные функции (глубокий поиск совпадений, приоритетные рекомендации, доступ ко всем сервисам) — по подписке.'
  },
  {
