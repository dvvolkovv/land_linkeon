    ...
    <Section id="features" ariaLabelledby="assistants-heading">
      <div className="grid lg:grid-cols-2 gap-10 md:gap-12 items-center min-w-0 [&>*]:min-w-0">
        <FadeIn>
          ...
          <a href={START_URL} data-cta="assistants-link" className="inline-flex items-center gap-1 py-2 min-h-11 text-brand-700 hover:text-brand-800 font-semibold text-sm">
