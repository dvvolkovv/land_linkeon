  ...
  return (
    <Section id="networking" ariaLabelledby="networking-heading" className="bg-white border-y border-slate-200">
      ...
      <div className="mt-10 text-center">
        <a href={SEARCH_URL} data-cta="networking-link" className="inline-flex items-center gap-1 py-2 min-h-11 text-indigo-600 hover:text-indigo-700 font-semibold text-sm">
