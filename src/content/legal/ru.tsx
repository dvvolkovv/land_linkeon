    ...
    return (
      <>
        ...
        <P>
          ...
          и фамилия пользователя, его интересы, ценности, навыки и намерения, а также
          идентификатор профиля — у пользователей, зарегистрировавшихся по номеру телефона,
          им является сам номер телефона. Данные передаются в исходном виде и обезличиванию
          перед передачей не подвергаются. Платёжные данные AI-провайдерам НЕ передаются.
        </P>
        <P>
  ...
  return (
    <>
      ...
      <P>
        ...
        контекст профиля (имя, фамилия, интересы, ценности, навыки, намерения, а также
        идентификатор профиля — у пользователей, зарегистрировавшихся по номеру телефона,
        им является сам номер телефона), загруженные изображения и аудиозаписи, аудиопоток
        при голосовом вводе, а также аудиообразец голоса при использовании функции озвучивания
        видео собственным голосом. Данные передаются в исходном виде и обезличиванию перед
        передачей не подвергаются.
      </P>
      <P>
